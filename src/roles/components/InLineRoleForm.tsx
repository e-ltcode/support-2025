...
import { ActionTypes, FormMode, IRoleFormProps } from "../types";

import { useRoleDispatch } from "roles/RoleProvider";

const InLineRoleForm = ({ inLine, mode, role, submitForm, children }: IRoleFormProps) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      console.log('InLineRoleForm.onSubmit', JSON.stringify(values, null, 2))
      submitForm(values)
